...
(function() {
  $(function() {
    return $('.delete_comment').on("ajax:success", function(ev) {
      return $(ev.target).closest(".comment_content").slideUp();
    });
  });

  $(function() {
    return $('.simple_form.new_comment').on("ajax:success", function(event) {
      return $('.comments').load(document.URL + ' .comments');
    });
  });
...
(function() {
  $(function() {
    return $('.delete_comment').on("ajax:success", function(ev) {
      return $(ev.target).closest(".comment_content").remove();
    });
  });
